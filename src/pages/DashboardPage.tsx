...
import { User, Wallet, TrendingUp, Eye, Heart, Edit, Settings, Copy, ExternalLink } from 'lucide-react';
...
import { mockNFTs, NFT } from '../data/mockData';

interface DashboardPageProps {
  onQuickBuy: (nft: NFT) => void;
}

export function DashboardPage({ onQuickBuy }: DashboardPageProps) {
  ...
  const ownedNFTs = mockNFTs.filter(nft => nft.owner.name === 'John Doe').slice(0, 6);
  const createdNFTs = mockNFTs.filter(nft => nft.creator.name === 'John Doe').slice(0, 4);

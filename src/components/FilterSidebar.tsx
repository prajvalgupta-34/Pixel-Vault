...
export function FilterSidebar({ isOpen, onClose, onFiltersChange }: FilterSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed md:sticky top-0 left-0 z-50 h-screen w-80 md:w-64 bg-background/95 backdrop-blur-lg border-r border-purple-500/30 overflow-y-auto">
        <div className="p-4">
          {/* Header */}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    setIsListedOnly(checked as boolean);
